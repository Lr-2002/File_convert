...
protoFile = "path/pose_deploy.prototext"
...
# 这里面应该是 input 一个已经剪过手的视频
input_source = "piano-data/fix-camera-hand/2020_11_13_01.mp4"
...
vid_writer = cv2.VideoWriter('output.mp4',cv2.VideoWriter_fourcc('M','P','4','V'), 24, (frame.shape[1],frame.shape[0]))
